...
public class BitcoinController {
	...
	public ModelAndView  getType(@PathVariable("paymentType") String paymentType, @RequestBody BitcoinDto bitcoinDto) {
		System.out.println("*********************"+bitcoinDto.getDescription() + " " +  bitcoinDto.getPrice());
		System.out.println("\nPayment type: " + paymentType);
		
		BitcoinPaymentTypeGatewayImpl paymentTypeGateway = (BitcoinPaymentTypeGatewayImpl) paymentTypeGatewayFactory.getGateway(PaymentType.BITCOIN);
