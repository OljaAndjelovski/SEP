...
public class OrderController {
	...
	// NE RADI
	/*
	 * @GetMapping(value = "/user/{username}", produces =
	 * MediaType.APPLICATION_JSON_VALUE) public ResponseEntity<List<OrderDto>>
	 * getOrdersFromUser(@PathVariable("username") String username) { return
	 * ResponseEntity.ok(mapper.mapManyToDTO(orderService.findAllFromUser(username))
	 * ); }
	 */
